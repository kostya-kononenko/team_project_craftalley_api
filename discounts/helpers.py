from discounts.models import Coupon, Campaign
...
class CouponHelper:
    ...
    def get_coupon_discounts(self):
        coupon_discounts = Coupon.objects.filter(
            minimum_cart_amount__lte=self.cart_total_amount
        )
        ...
        for coupon_discount in coupon_discounts:
            discount = AvailableDiscount(
                ...
                amount={"rate": coupon_discount.discount_rate, "amount": None},
            )
